...
const AdvisorLinktree = () => {
  ...
  const advisor = advisorId ? getTeamMemberById(advisorId) : undefined;
  ...
  const links = [
    {
      ...
      description: "Réservez une consultation gratuite",
    ...
    },
    {
      icon: Phone,
      label: "Appeler",
      description: "(514) 555-0123",
      href: "tel:+15145550123",
    },
    ...(advisor.linkedin ? [{
      icon: Linkedin,
      label: "LinkedIn",
      description: "Voir mon profil professionnel",
    ...
    ...(advisor.facebook ? [{
      icon: Facebook,
      label: "Facebook",
      description: "Suivez-moi sur Facebook",
    ...
    }] : []),
    {
      ...
      description: "lessimplificateursfinanciers.ca",
      href: "/",
    },
    {
      icon: MessageCircle,
      label: "WhatsApp",
      description: "Discutez avec moi directement",
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center px-4 py-8 max-w-md mx-auto w-full">
          ...
          >
            ...
            {/* Description */}
            {advisor.description && (
              <p className="text-gray-300 text-sm leading-relaxed mt-4 max-w-xs mx-auto">
                {advisor.description}
              </p>
            )}
          </motion.div>
              ...
              const content = (
                <div
                  className={`w-full p-4 rounded-2xl border transition-all duration-300 group
                    ${link.primary 
                      ? "bg-gold-500 border-gold-500 hover:bg-gold-600 hover:border-gold-600" 
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 text-left">
                      <p className={`font-medium ${link.primary ? "text-white" : "text-white"}`}>
                        {link.label}
                      </p>
                      <p className={`text-sm ${link.primary ? "text-white/80" : "text-gray-400"}`}>
                        {link.description}
                      </p>
                    </div>
                  </div>
          ...
          >
            ...
            >
              Les Simplificateurs Financiers
            </Link>
          </motion.div>
        </div>
      </div>
