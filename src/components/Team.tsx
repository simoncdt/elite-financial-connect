...
import { getLeaders, getAdvisors, TeamMember } from "@/lib/team-data";
    ...
    <>
      ...
      <section id="team" className="py-20 lg:py-32 bg-background">
        <div className="section-container">
          ...
          >
            <span className="text-gold-500 text-sm font-medium uppercase mb-4 block">
              Notre équipe
            </span>
            <h2 className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
            {leaders.map((m, i) => (
              <LeaderCard
                ...
                member={m}
                index={i}
                onBookAppointment={setSelectedAdvisor}
              />
            ))}
          </div>
          ...
          <motion.div className="text-center mb-16">
            <Link
              to="/equipe"
              className="inline-flex items-center gap-2 text-gold-500 hover:text-gold-600 font-medium"
            >
              Voir toute l’équipe
